...
### Content
During the winter break I try to add coin in my game, which you can control the bean to collect the coin and get score from it, but I fail, so I try to change the gravity and size.

...
Now I  am in 5 and 7 because after I been creating things, there is still a lot I need to improve amd adds, because right now my game only have a bean that player can control it to move, so I need to add more and improve to make it actually like a game.
